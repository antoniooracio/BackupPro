...
SECRET_KEY = 'django-insecure-x-%j%149yws7ci9%!3(=%z2(bk*7$*o1xfn=xinfo_r5j1srfc'

# SECURITY WARNING: don't run with debug turned on in production!
# DEBUG com valor True é Desenvolvimento, False Produção
DEBUG = True

ALLOWED_HOSTS = ['*'] # alterar para o nome do DNS
